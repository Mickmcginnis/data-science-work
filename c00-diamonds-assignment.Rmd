...
- Price seems to increase with carat, but there does not seem to be any specific curve to fit the data.
...
- Price seems to increase with carat but there does not seem to be any specific curve to fit the data
- The worse cut diamonds seem to be less expensive than the ideal ones, which helps to define a trend in the data more than just observing the carat and price  
